---
pagetitle: "SRM Slides"
description: "Slides for the R workshop at the SRM University, Sonipat."
format: 
  revealjs:
...
[Dr. Ajay Kumar Koli, PhD $\cdot$ SRM University $\cdot$ 2 May 2024]{.r-fit-text}
...
[We [think]{.theme-red} we look like this but ...]{.r-fit-text}

## While working {.center}

[Our [actual]{.theme-red} look.]{.r-fit-text}
